...
export const ERROR_MESSAGES = {
  ...
  SAVE_FAILED:
    "Failed to save the file. Please check your permissions and try again.",
  LOAD_FAILED:
    "Failed to load the file. The file may be corrupted or in an invalid format.",
  RENAME_FAILED:
    "Failed to rename the file. A file with that name may already exist.",
  DELETE_FAILED: "Failed to delete the file. Please check your permissions.",
  DIRECTORY_ACCESS_DENIED:
    "Cannot access the selected directory. Please check your permissions.",
